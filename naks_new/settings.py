"""
Django settings for naks_new project.
...
SECRET_KEY = '7bhe#nxyje=d+pnk!sy*e=+ziol(9cbf-x1l^#t#&z=eol2q)g'
...
WSGI_APPLICATION = 'naks_new.wsgi.application'
