...
urlpatterns = [
    ...
    path('spks_composition/', mainapp.spks_composition, name='spks_composition'),
    path('spks_composition_region/', mainapp.spks_composition_region, name='spks_composition_region'),
    path('spks_composition_experts/', mainapp.spks_composition_experts, name='spks_composition_experts'),
    path('spks_comiss/', mainapp.spks_comiss, name='spks_comiss'),
    path('spks_work_plan/', mainapp.spks_work_plan, name='spks_work_plan'),
    path('spks_protocols/', mainapp.spks_protocols, name='spks_protocols'),
